...
# 1. import data
data = pd.read_excel("../../../data/Suzuki_HTE/Suzuki_HTE_rxnfp.xlsx")
...
for batch in range(data.shape[0]):
    ...
    # experimental data
    meta.append(torch.tensor([], dtype=torch.float32))
...
fig.suptitle("MMYield for Suzuki dataset", fontsize=16)
